...
class ViewController: UIViewController {
    ...
    @IBAction func rollButtonPressed(_ sender: UIButton) {
        ...
        /*
         ...
         diceImageView2.image = diceArray[Int.random(in: 1...(diceArray.count - 1))]
         */
        ...
        /*
         diceImageView1.image = diceArray[Int.random(in: 1..<6)]
         diceImageView2.image = diceArray[Int.random(in: 1..<6)]
         */
